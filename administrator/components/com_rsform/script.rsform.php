...
.red {
	...
	<div class="rsform-column-10">
		...
		<?php } ?>
		<h2>Changelog v3.1.8</h2>
		<ul class="version-history">
            <li><span class="version-upgraded">Upg</span> 'File Upload' will now accept 'webp' images when 'Allow Only Images' is set to 'Yes'.</li>
            <li><span class="version-upgraded">Upg</span> Thumbs from the 'File Upload' field can now be created as webp images.</li>
            <li><span class="version-upgraded">Upg</span> TCPDF updated to 6.6.2 for PHP 8.1 compatibility.</li>
            <li><span class="version-fixed">Fix</span> Google Maps API was showing a warning in the console due to a missing callback.</li>
            <li><span class="version-fixed">Fix</span> Viewing PDF submissions in the frontend could display a PHP warning due to a missing $app->close() call.</li>
            <li><span class="version-fixed">Fix</span> Specifying a 'List of Disposable Email Domains' in combination with the 'Email Validation' rule could throw a PHP warning in some cases.</li>
		</ul>
