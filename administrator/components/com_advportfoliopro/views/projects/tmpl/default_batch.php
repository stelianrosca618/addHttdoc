...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo JText::_('COM_ADVPORTFOLIOPRO_PROJECTS_BATCH_OPTIONS'); ?></h3>
	</div>
	<div class="modal-body">
		<p><?php echo JText::_('COM_ADVPORTFOLIOPRO_PROJECTS_BATCH_TIP'); ?></p>
		...
		<div class="control-group">
			<div class="controls">
				<?php echo JHtml::_('batch.item', 'com_advportfoliopro');?>
			</div>
		</div>
		<?php endif; ?>
	</div>
