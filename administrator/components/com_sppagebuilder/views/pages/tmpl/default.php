			...
			<form action="<?php echo JRoute::_('index.php?option=com_sppagebuilder&view=pages');?>" method="post" name="adminForm" id="adminForm">
				...
				<?php if(!$this->params->get('joomshaper_license_key')) : ?>
					<div class="alert alert-info" role="alert">
						Hello! Would you like to receive automatic updates and get premium support? Please <a href="<?php echo JRoute::_('index.php?option=com_config&view=component&component=com_sppagebuilder'); ?>#licenseupdate">activate SP Page Builder.</a>
				...
				<?php if(!$this->params->get('gmap_api')) : ?>
					<div class="alert alert-info" role="alert">
						Please add <a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">Google Maps API</a> credentials <a href="<?php echo JRoute::_('index.php?option=com_config&view=component&component=com_sppagebuilder&path=&return=' . urlencode(base64_encode(JUri::getInstance())));?>">here</a> to use Google Maps.
						<button type="button" class="close" data-dismiss="alert" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
