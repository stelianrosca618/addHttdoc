...
SpAddonsConfig::addonConfig(
    [
        ...
        'inline' => [
            'buttons' => [
                'articles_general_options' => [
                    'action' => 'dropdown',
                    'icon' => 'addon::articles',
                    'tooltip' => Text::_('COM_SPPAGEBUILDER_ADDON_ARTICLES'),
                    'fieldset' => [
                        'tab_groups' => [
                            'source' => [
                                'fields' => [
                                ...
                                'fields' => [
                                    [
                                        ...
                                        'link_catid' => [
                                            ...
                                            'title' => Text::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_CATID'),
                                            'desc' => Text::_('COM_SPPAGEBUILDER_ADDON_ARTICLES_CATID_DESC'),
                                            'depends' => [['resource', '=', 'article'], ['link_articles', '=', '1']],
                                        ],
                                        ...
                                        'link_k2catid' => [
                                            ...
                                            'desc' => Text::_('COM_SPPAGEBUILDER_ADDON_K2_CATID_DESC'),
                                            'values' => SpPgaeBuilderBase::k2CatList(),
                                            'depends' => [['resource', '=', 'k2'], ['link_articles', '=', '1']],
                                        ],

                                        'all_articles_btn_tab' => [
                                            'type' => 'buttons',
                                            'std' => 'normal',
                                            'values' => [
                                        ...
                                        'all_articles_btn_typography' => [
                                            ...
                                            'depends' => [
                                                ['link_articles', '=', '1'],
                                                ['all_articles_btn_tab', '=', 'typography'],
                                            ],
                                        ],
