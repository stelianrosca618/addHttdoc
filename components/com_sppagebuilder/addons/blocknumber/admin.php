...
SpAddonsConfig::addonConfig(
	[
		...
		'inline'     => [
			'buttons' => [
				'blocknumber_general_options' => [
					'action'   => 'dropdown',
					'icon'     => 'addon::blocknumber',
					'tooltip'  => Text::_('COM_SPPAGEBUILDER_ADDON_BLOCKNUMBER'),
					'fieldset' => [
						'tab_groups' => [
							'content' => [
								'fields' => [
				...
				'block_number_typography_options' => [
					'action'   => 'dropdown',
					'icon'     => 'typography',
							...
							'content' => [
								...
								'fields'        => [
									[
										'heading_color' => [
											'type'    => 'color',
											'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_HEADING_COLOR'),
										],

										'text_color' => [
											'type'    => 'color',
											'title'   => Text::_('COM_SPPAGEBUILDER_GLOBAL_CONTENT_COLOR'),
										],
									],
								],
							],
