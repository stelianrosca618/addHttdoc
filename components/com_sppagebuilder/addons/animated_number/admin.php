...
SpAddonsConfig::addonConfig([
	...
	'inline'     => [
		...
		'buttons'         => [
			'animated_number_general_options' => [
				'action'   => 'dropdown',
				'icon'     => 'addon::animated_number',
				'tooltip'  => Text::_('COM_SPPAGEBUILDER_ADDON_ANIMATED_NUMBER'),
				'fieldset' => [
					'tab_groups' => [
						'content' => [
							'fields' => [
						...
						'title' => [
							'fields' => [
								...
								'color' => [
									'title_color' => [
										'type'   => 'color',
										'title'  => Text::_('COM_SPPAGEBUILDER_ADDON_ANIMATED_TITLE_COLOR'),
										'desc'   => Text::_('COM_SPPAGEBUILDER_ADDON_ANIMATED_TITLE_COLOR_DESC'),
										'inline' => true,
									],
								],
			...
			'animated_number_typography_options' => [
				'action'   => 'dropdown',
				'icon'     => 'typography',
				'fieldset' => [
					[
			...
			'animated_number_alignment_separator' => [
				'action' => 'separator',
			],
