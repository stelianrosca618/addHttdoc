...
class SppagebuilderAddonFeature extends SppagebuilderAddons
{
	...
	public function css()
	{
		...
		$css .= $cssHelper->generateStyle('&:hover .sppb-feature-box-title', $settings, ['title_hover_color' => 'color'], false);
		$css .= $cssHelper->generateStyle('&:hover .sppb-addon-text', $settings, ['addon_hover_color' => 'color'], false);
		$css .= $cssHelper->generateStyle('&:hover .sppb-icon-container', $settings, ['icon_hover_color' => 'color'], false);
	...
	public static function getTemplate()
	{
		...
		<#
			...
			if(isObject || isString) {
				...
				rel = urlObj.nofollow ? "noopener noreferrer": "";
			}
		...
		<div class="sppb-addon sppb-addon-feature {{ data.class }} {{ alignment }}">
			...
			let relBtn = "";
				...
				relBtn = urlObjBtn.nofollow ? "noopener noreferrer": "";
