...
class SppagebuilderAddonArticles_scroller extends SppagebuilderAddons
{
	...
	public function css()
	{
		...
		$tickerHeadingStyle        = $cssHelper->generateStyle('.sppb-articles-scroller-meta-date-left span.sppb-articles-scroller-day, .sppb-articles-ticker-heading', $settings, ['ticker_heading_fontsize' => 'font-size', 'ticker_heading_font_weight' => 'font-weight']);
		...
		$rightTitleFontStyle       = $cssHelper->generateStyle('.sppb-addon-articles-scroller-title', $settings, ['right_title_font_size' => 'font-size', 'content_title_font_weight' => 'font-weight']);
		...
		$carouselTitleStyleUnits = ['carousel_title_color' => false, 'carousel_title_margin' => false];
