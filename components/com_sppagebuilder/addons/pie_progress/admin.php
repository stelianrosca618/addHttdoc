...
SpAddonsConfig::addonConfig([
    ...
    'inline'     => [
        ...
        'buttons'         => [
            'pie_progress_general_options' => [
                'action'   => 'dropdown',
                'icon'     => 'addon::pie_progress',
                'tooltip'  => Text::_('COM_SPPAGEBUILDER_ADDON_PIE_PROGRESS'),
                'fieldset' => [
                    'tab_groups' => [
                        'progress' => [
                            'fields' => [
            ...
            'pie_progress_typography_separator' => [
                'action' => 'separator',
            ],
            ...
            'pie_progress_color_options' => [
                ...
                'placeholder' => [
                    ...
                    'display_field' => 'border_active_color',
                ],
                'fieldset' => [
                    [
                        'border_color' => [
