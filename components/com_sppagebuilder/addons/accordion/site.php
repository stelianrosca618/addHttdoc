...
class SppagebuilderAddonAccordion extends SppagebuilderAddons
{
	...
	public static function getTemplate()
	{
		...
		$output .= $lodash->unit('margin-top', '.sppb-addon-accordion-title', 'data.title_margin_top', 'px');
		$output .= $lodash->unit('margin-bottom', '.sppb-addon-accordion-title', 'data.title_margin_bottom', 'px');
		$output .= $lodash->color('color', '.sppb-addon-accordion-title', 'data.title_text_color');
		$output .= $lodash->typography('.sppb-addon-accordion-title', 'data.title_typography', $titleTypographyFallbacks);
		...
		$output .= $lodash->spacing('padding', '.sppb-panel-heading', 'data.item_title_padding');
