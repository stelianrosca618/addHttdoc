...
<div class="uk-grid uk-grid-small uk-form-row">
  <label class="uk-form-label uk-width-1-5" for="href" class="hastip" title="<?php echo Text::_('WF_LABEL_URL_DESC'); ?>"><?php echo Text::_('WF_LABEL_URL'); ?></label>
...
<div class="uk-grid uk-grid-small uk-form-row">
  <label class="uk-form-label uk-width-1-5" for="title" class="hastip" title="<?php echo Text::_('WF_LABEL_TITLE_DESC'); ?>"><?php echo Text::_('WF_LABEL_TITLE'); ?></label>
...
<div class="uk-grid uk-grid-small uk-form-row">
  <label for="format" class="uk-form-label uk-width-1-5 hastip" title="<?php echo Text::_('WF_FILEMANAGER_FORMAT_DESC', 'Format'); ?>"><?php echo Text::_('WF_FILEMANAGER_FORMAT', 'Format'); ?></label>
  <div class="uk-form-controls uk-width-3-10">
    <select id="format">
      <option value="link"><?php echo Text::_('WF_OPTION_FILEMANAGER_FORMAT_LINK', 'Link'); ?></option>
      <option value="embed"><?php echo Text::_('WF_OPTION_FILEMANAGER_FORMAT_EMBED', 'Embed'); ?></option>
    </select>
  </div>

  <label for="format_openwith" class="uk-form-label uk-width-2-10 hastip" title="<?php echo Text::_('WF_FILEMANAGER_FORMAT_OPENWITH_DESC', 'Open With'); ?>"><?php echo Text::_('WF_FILEMANAGER_FORMAT_OPENWITH', 'Open With'); ?></label>
  <div class="uk-form-controls uk-width-3-10">
    <select id="format_openwith">
      <option value=""><?php echo Text::_('WF_OPTION_NOT_SET'); ?></option>
      <option value="googledocs"><?php echo Text::_('WF_OPTION_FILEMANAGER_GOOGLEDOCS', 'Google Docs Viewer'); ?></option>
      <option value="officeapps"><?php echo Text::_('WF_OPTION_FILEMANAGER_OFFICEAPPS', 'Office Apps Viewer'); ?></option>
    </select>
  </div>
</div>
...
<div class="uk-placeholder filemanager-link-options">
  <div class="uk-grid uk-grid-small uk-form-row">
    <label for="text" class="uk-form-label uk-width-2-10 hastip" title="<?php echo Text::_('WF_FILEMANAGER_TEXT_DESC'); ?>"><?php echo Text::_('WF_FILEMANAGER_TEXT'); ?></label>
    <div class="uk-form-controls uk-width-4-10">
      <input id="text" type="text" value="" required />
    </div>

    <label for="target" class="uk-form-label uk-width-1-10 hastip" title="<?php echo Text::_('WF_LABEL_TARGET_DESC'); ?>"><?php echo Text::_('WF_LABEL_TARGET'); ?></label>
    <div class="uk-form-controls uk-width-3-10">
      <select id="target">
        <option value=""><?php echo Text::_('WF_OPTION_NOT_SET'); ?></option>
        ...
        <option value="download"><?php echo Text::_('WF_OPTION_TARGET_DOWNLOAD', 'Download'); ?></option>
      </select>
    </div>
  </div>
  <div class="uk-grid uk-grid-small uk-form-row">
    <label class="uk-form-label uk-width-1-5 hastip" title="<?php echo Text::_('WF_FILEMANAGER_LAYOUT_DESC'); ?>"><?php echo Text::_('WF_FILEMANAGER_LAYOUT'); ?></label>
      ...
      <div class="uk-form-controls uk-width-1-6" id="layout_icon" data-type="icon">
        <div class="uk-panel uk-panel-box">
          <label class="uk-form-label uk-width-1-1">
            ...
            <?php echo Text::_('WF_FILEMANAGER_LAYOUT_ICON'); ?>
          </label>
        </div>
      </div>
      ...
      <div class="uk-form-controls uk-width-1-6" id="layout_text" data-type="text">
        <div class="uk-panel uk-panel-box">
          <label class="uk-form-label uk-width-1-1">
            ...
            <?php echo Text::_('WF_FILEMANAGER_LAYOUT_TEXT'); ?>
          </label>
        </div>
      </div>
      ...
      <div class="uk-form-controls uk-width-2-6" id="layout_size" data-type="size">
        <div class="uk-panel uk-panel-box">
          <label class="uk-form-label uk-width-2-5">
            ...
            <?php echo Text::_('WF_FILEMANAGER_LAYOUT_SIZE'); ?>
          </label>
          <div class="uk-form-icon uk-form-icon-flip uk-width-3-5">
            <input type="text" value="" />
            <a href="#" title="<?php echo Text::_('WF_FILEMANAGER_LAYOUT_RELOAD'); ?>" class="uk-icon-refresh layout_option_reload"></a>
          </div>
        </div>
      </div>
      ...
      <div class="uk-form-controls uk-width-2-6" id="layout_date" data-type="date">
        <div class="uk-panel uk-panel-box">
          <label class="uk-form-label uk-width-2-5">
            ...
            <?php echo Text::_('WF_FILEMANAGER_LAYOUT_DATE'); ?>
          </label>
          <div class="uk-form-icon uk-form-icon-flip uk-width-3-5">
            <input type="text" value="" />
            <a href="#" title="<?php echo Text::_('WF_FILEMANAGER_LAYOUT_RELOAD'); ?>" class="uk-icon-refresh layout_option_reload"></a>
  ...
  <div class="uk-grid uk-grid-small uk-form-row">
    <label for="size_class" class="uk-form-label uk-width-1-5 hastip" title="<?php echo Text::_('WF_FILEMANAGER_SIZE_CLASS_DESC'); ?>"><?php echo Text::_('WF_FILEMANAGER_SIZE_CLASS'); ?></label>
    <div class="uk-form-controls uk-width-3-10">
    ...
    <label for="date_class" class="uk-form-label uk-width-1-5 hastip" title="<?php echo Text::_('WF_FILEMANAGER_DATE_CLASS_DESC'); ?>"><?php echo Text::_('WF_FILEMANAGER_DATE_CLASS'); ?></label></td>
    <div class="uk-form-controls uk-width-3-10">
