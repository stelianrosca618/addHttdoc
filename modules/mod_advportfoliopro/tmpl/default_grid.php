...
JHtml::_('script', 'com_advportfoliopro/jquery.flexslider.js', false, true);
...
<div id="portfolio-module-<?php echo $id; ?>"
	class="portfolio-module portfolio-module<?php echo $moduleclass_sfx; ?>"
